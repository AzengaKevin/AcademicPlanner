 ...
 * Use the [AcademicCalendarFragment.newInstance] factory method to
...
class AcademicCalendarFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AcademicCalendarFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AcademicCalendarFragment().apply {
